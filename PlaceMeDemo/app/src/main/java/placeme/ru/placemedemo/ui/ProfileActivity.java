...
public class ProfileActivity extends AppCompatActivity {
    ...
    private void loadProfileImage() {
        ...
        ToolTip.Builder builder = new ToolTip.Builder(this, mCircleImageView,
                findViewById(R.id.root_p), getString(R.string.tip_avatar_p) + "\n" + getString(R.string.tip_avatar_s), ToolTip.POSITION_LEFT_TO);
    ...
    private void setEditButton() {
        ...
        ToolTip.Builder builder = new ToolTip.Builder(this, editButton,
                findViewById(R.id.root_p), getString(R.string.tip_edit_profile_p) + "\n" + getString(R.string.tip_edit_profile_s), ToolTip.POSITION_LEFT_TO);
