...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if( childEventListener == null ) {
            childEventListener = new ChildEventListener() {
                ...
                public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                    ...
                    Log.d("aaaaaaaaaaaa", ((Integer)user.getId()).toString());
                    Log.d("bbbbbbbbbbbb", ((Integer)LoginUtility.getLoggedIn(MainActivity.this)).toString());
                    if(((Integer)LoginUtility.getLoggedIn(MainActivity.this)).equals(user.getId())) {
        ...
        User user = new User("Andrey", "login@test.com", "https://vk.com/hotckiss");
        mDatabase.child("users/1").setValue(user);*/
        //createMapView();
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(userInfo != null) {
                    Toast.makeText(getApplicationContext(), "Logged as " + userInfo.getName(), Toast.LENGTH_SHORT).show();
                } else {
                    Log.wtf("base", "no user bug");
                ...
                //LoginUtility.setLoggedOut(MainActivity.this);
                DatabaseReference mDatabaseReference1 = mBase.getReference().child("authdata");
                AuthData user = new AuthData(3, "gluboko@glyazhu", "0987654321");
                mDatabaseReference1.child("3").setValue(user);
                /*user = new AuthData(0, "alina@erokhina", "12345");
                mDatabaseReference1.child("0").setValue(user);
                user = new AuthData(2, "vika@erokhina", "12345");
                mDatabaseReference1.child("2").setValue(user);*/
                mDatabaseReference1 = mBase.getReference().child("users");
                User user2 = new User(3, "Anna", "Petrova", "glyazhu");
                mDatabaseReference1.child("3").setValue(user2);
                /*user = new User(1, "Andrey", "Kirilenko", "hotckiss");
                mDatabaseReference1.child("1").setValue(user);
                user = new User(2, "Vika", "Erokhina", "kingsfoill");
                mDatabaseReference1.child("2").setValue(user);*/
